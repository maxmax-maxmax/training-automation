...
def _prepare_event_data(  # pylint: disable=too-many-arguments,too-many-positional-arguments
    ...
    data: dict[str, Any] = {
        ...
        "category": category if category else "WORKOUT",
        "name": name,
...
async def add_or_update_event(  # pylint: disable=too-many-arguments,too-many-positional-arguments
    ...
    Args:
        ...
        workout_doc: steps as a list of Step objects, or a plain string for note descriptions
        workout_type: Workout type (e.g. Ride, Run, Swim, Walk, Row, Note)
        ...
        category: Event category (e.g. NOTE, WORKOUT, RACE, SICK, HOLIDAY) (optional, defaults to WORKOUT)
        color: Event color (e.g. red, orange, green, blue) (optional)
        for_week: If True, creates the note as a week note visible in the week notes column (optional)
    ...
    try:
        event_data = _prepare_event_data(
            name, workout_type, start_date, workout_doc, moving_time, distance, category, color, for_week
        )
